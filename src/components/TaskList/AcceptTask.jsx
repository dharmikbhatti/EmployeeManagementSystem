            ...
            <div className="bg-gradient-to-br from-pink-400 to-pink-600 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-500 hover:scale-105 transform hover:-rotate-2">
                ...
                <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                        <span className="px-3 py-1 text-xs font-semibold text-white bg-pink-700 rounded-full">Category</span>
                        <span className="text-sm text-white">Due: July 30, 2025</span>
                    </div>
                    <h2 className="text-xl font-bold text-white mb-2">Project Review Meeting</h2>
                    <p className="text-white opacity-90 mb-4">Review Q3 project milestones and discuss upcoming deliverables with the team.</p>
