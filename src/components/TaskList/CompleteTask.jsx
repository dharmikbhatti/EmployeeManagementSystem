            ...
            <div className="bg-gradient-to-br from-cyan-400 to-cyan-600 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-500 hover:scale-105 transform hover:-rotate-2">
                ...
                <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                        <span className="px-3 py-1 text-xs font-semibold text-white bg-cyan-700 rounded-full">Low Priority</span>
                        <span className="text-sm text-white">Due: Aug 15, 2025</span>
                    </div>
                    <h2 className="text-xl font-bold text-white mb-2">Documentation Update</h2>
                    <p className="text-white opacity-90 mb-4">Update the technical documentation with recent changes and improvements.</p>
